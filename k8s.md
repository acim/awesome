...
<!-- - [Using NodeSelector to Schedule Deployments with large volumes of Stateful Data on Kubernetes](broken-link:https://medium.com/@jmarhee/using-nodeselector-to-schedule-deployments-with-large-volumes-of-stateful-data-on-kubernetes-46bd3ac6059d) -->
...
<!-- - [stern - tail multiple pods on Kubernetes and multiple containers within the pod](broken-link:https://github.com/wercker/stern) -->
...
<!-- - [10 most important differences between OpenShift and Kubernetes](broken-link:https://cloudowski.com/articles/10-differences-between-openshift-and-kubernetes) -->
...
<!-- - [Helmfile - chart deployment tool](broken-link:https://medium.com/@devopseylife/helmfile-aka-helm-chart-deployment-tool-4e3378fad242) -->
...
<!-- - [Kubernetes without kube-proxy](broken-link:https://docs.cilium.io/en/stable/gettingstarted/kubeproxy-free/) -->
